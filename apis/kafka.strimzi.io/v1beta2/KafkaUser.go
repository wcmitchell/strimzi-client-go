...
type KafkaUserSpecAuthorizationAclsElem struct {
	...
	// List of operations to allow or deny. Supported operations are: Read, Write,
	// Create, Delete, Alter, Describe, ClusterAction, AlterConfigs, DescribeConfigs,
	// IdempotentWrite and All. Only certain operations work with the specified
	// resource.
