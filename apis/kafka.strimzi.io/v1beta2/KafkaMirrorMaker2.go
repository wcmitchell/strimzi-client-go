...
type KafkaMirrorMaker2SpecClustersElemAuthentication struct {
	...
	ClientAssertion *KafkaMirrorMaker2SpecClustersElemAuthenticationClientAssertion `json:"clientAssertion,omitempty" yaml:"clientAssertion,omitempty" mapstructure:"clientAssertion,omitempty"`
	...
	SaslExtensions KafkaMirrorMaker2SpecClustersElemAuthenticationSaslExtensions `json:"saslExtensions,omitempty" yaml:"saslExtensions,omitempty" mapstructure:"saslExtensions,omitempty"`
...
// Link to Kubernetes secret containing the client assertion which was manually
// configured for the client.
type KafkaMirrorMaker2SpecClustersElemAuthenticationClientAssertion struct {
	// The key under which the secret value is stored in the Kubernetes Secret.
	Key string `json:"key" yaml:"key" mapstructure:"key"`
...
// SASL extensions parameters.
type KafkaMirrorMaker2SpecClustersElemAuthenticationSaslExtensions map[string]string
...
type KafkaMirrorMaker2SpecMirrorsElemCheckpointConnector struct {
	...
	AlterOffsets *KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorAlterOffsets `json:"alterOffsets,omitempty" yaml:"alterOffsets,omitempty" mapstructure:"alterOffsets,omitempty"`
...
// Configuration for altering offsets.
type KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorAlterOffsets struct {
	// Reference to the ConfigMap where the new offsets are stored.
	FromConfigMap KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorAlterOffsetsFromConfigMap `json:"fromConfigMap" yaml:"fromConfigMap" mapstructure:"fromConfigMap"`
}

// Reference to the ConfigMap where the new offsets are stored.
type KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorAlterOffsetsFromConfigMap struct {
	// Name corresponds to the JSON schema field "name".
	Name *string `json:"name,omitempty" yaml:"name,omitempty" mapstructure:"name,omitempty"`
}
...
type KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorListOffsets struct {
	...
	ToConfigMap KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorListOffsetsToConfigMap `json:"toConfigMap" yaml:"toConfigMap" mapstructure:"toConfigMap"`
}

// Reference to the ConfigMap where the list of offsets will be written to.
type KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorListOffsetsToConfigMap struct {
	// Name corresponds to the JSON schema field "name".
	Name *string `json:"name,omitempty" yaml:"name,omitempty" mapstructure:"name,omitempty"`
}
...
type KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnector struct {
	// Configuration for altering offsets.
	AlterOffsets *KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorAlterOffsets `json:"alterOffsets,omitempty" yaml:"alterOffsets,omitempty" mapstructure:"alterOffsets,omitempty"`
...
// Configuration for altering offsets.
type KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorAlterOffsets struct {
	// Reference to the ConfigMap where the new offsets are stored.
	FromConfigMap KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorAlterOffsetsFromConfigMap `json:"fromConfigMap" yaml:"fromConfigMap" mapstructure:"fromConfigMap"`
}

// Reference to the ConfigMap where the new offsets are stored.
type KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorAlterOffsetsFromConfigMap struct {
	// Name corresponds to the JSON schema field "name".
	Name *string `json:"name,omitempty" yaml:"name,omitempty" mapstructure:"name,omitempty"`
}
...
type KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorListOffsets struct {
	// Reference to the ConfigMap where the list of offsets will be written to.
	ToConfigMap KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorListOffsetsToConfigMap `json:"toConfigMap" yaml:"toConfigMap" mapstructure:"toConfigMap"`
}

// Reference to the ConfigMap where the list of offsets will be written to.
type KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorListOffsetsToConfigMap struct {
	// Name corresponds to the JSON schema field "name".
	Name *string `json:"name,omitempty" yaml:"name,omitempty" mapstructure:"name,omitempty"`
}
...
type KafkaMirrorMaker2SpecMirrorsElemSourceConnector struct {
	// Configuration for altering offsets.
	AlterOffsets *KafkaMirrorMaker2SpecMirrorsElemSourceConnectorAlterOffsets `json:"alterOffsets,omitempty" yaml:"alterOffsets,omitempty" mapstructure:"alterOffsets,omitempty"`
...
// Configuration for altering offsets.
type KafkaMirrorMaker2SpecMirrorsElemSourceConnectorAlterOffsets struct {
	// Reference to the ConfigMap where the new offsets are stored.
	FromConfigMap KafkaMirrorMaker2SpecMirrorsElemSourceConnectorAlterOffsetsFromConfigMap `json:"fromConfigMap" yaml:"fromConfigMap" mapstructure:"fromConfigMap"`
}

// Reference to the ConfigMap where the new offsets are stored.
type KafkaMirrorMaker2SpecMirrorsElemSourceConnectorAlterOffsetsFromConfigMap struct {
	// Name corresponds to the JSON schema field "name".
	Name *string `json:"name,omitempty" yaml:"name,omitempty" mapstructure:"name,omitempty"`
}
...
type KafkaMirrorMaker2SpecMirrorsElemSourceConnectorListOffsets struct {
	// Reference to the ConfigMap where the list of offsets will be written to.
	ToConfigMap KafkaMirrorMaker2SpecMirrorsElemSourceConnectorListOffsetsToConfigMap `json:"toConfigMap" yaml:"toConfigMap" mapstructure:"toConfigMap"`
}

// Reference to the ConfigMap where the list of offsets will be written to.
type KafkaMirrorMaker2SpecMirrorsElemSourceConnectorListOffsetsToConfigMap struct {
	// Name corresponds to the JSON schema field "name".
	Name *string `json:"name,omitempty" yaml:"name,omitempty" mapstructure:"name,omitempty"`
}
...
type KafkaMirrorMaker2SpecTemplateBuildContainer struct {
	...
	VolumeMounts []KafkaMirrorMaker2SpecTemplateBuildContainerVolumeMountsElem `json:"volumeMounts,omitempty" yaml:"volumeMounts,omitempty" mapstructure:"volumeMounts,omitempty"`
}
...
type KafkaMirrorMaker2SpecTemplateBuildContainerEnvElem struct {
	...
	// variable is set.
	ValueFrom *KafkaMirrorMaker2SpecTemplateBuildContainerEnvElemValueFrom `json:"valueFrom,omitempty" yaml:"valueFrom,omitempty" mapstructure:"valueFrom,omitempty"`
}

// Reference to the secret or config map property to which the environment variable
// is set.
type KafkaMirrorMaker2SpecTemplateBuildContainerEnvElemValueFrom struct {
	// Reference to a key in a config map.
	ConfigMapKeyRef *KafkaMirrorMaker2SpecTemplateBuildContainerEnvElemValueFromConfigMapKeyRef `json:"configMapKeyRef,omitempty" yaml:"configMapKeyRef,omitempty" mapstructure:"configMapKeyRef,omitempty"`

	// Reference to a key in a secret.
	SecretKeyRef *KafkaMirrorMaker2SpecTemplateBuildContainerEnvElemValueFromSecretKeyRef `json:"secretKeyRef,omitempty" yaml:"secretKeyRef,omitempty" mapstructure:"secretKeyRef,omitempty"`
}

// Reference to a key in a config map.
type KafkaMirrorMaker2SpecTemplateBuildContainerEnvElemValueFromConfigMapKeyRef struct {
	// Key corresponds to the JSON schema field "key".
	Key *string `json:"key,omitempty" yaml:"key,omitempty" mapstructure:"key,omitempty"`
...
// Reference to a key in a secret.
type KafkaMirrorMaker2SpecTemplateBuildContainerEnvElemValueFromSecretKeyRef struct {
	// Key corresponds to the JSON schema field "key".
	Key *string `json:"key,omitempty" yaml:"key,omitempty" mapstructure:"key,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateBuildContainerSecurityContext struct {
	...
	AppArmorProfile *KafkaMirrorMaker2SpecTemplateBuildContainerSecurityContextAppArmorProfile `json:"appArmorProfile,omitempty" yaml:"appArmorProfile,omitempty" mapstructure:"appArmorProfile,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateBuildContainerSecurityContextAppArmorProfile struct {
...
type KafkaMirrorMaker2SpecTemplateBuildContainerVolumeMountsElem struct {
...
type KafkaMirrorMaker2SpecTemplateBuildPod struct {
	...
	Volumes []KafkaMirrorMaker2SpecTemplateBuildPodVolumesElem `json:"volumes,omitempty" yaml:"volumes,omitempty" mapstructure:"volumes,omitempty"`
}
...
type KafkaMirrorMaker2SpecTemplateBuildPodSecurityContext struct {
	// AppArmorProfile corresponds to the JSON schema field "appArmorProfile".
	AppArmorProfile *KafkaMirrorMaker2SpecTemplateBuildPodSecurityContextAppArmorProfile `json:"appArmorProfile,omitempty" yaml:"appArmorProfile,omitempty" mapstructure:"appArmorProfile,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateBuildPodSecurityContextAppArmorProfile struct {
	// LocalhostProfile corresponds to the JSON schema field "localhostProfile".
	LocalhostProfile *string `json:"localhostProfile,omitempty" yaml:"localhostProfile,omitempty" mapstructure:"localhostProfile,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElem struct {
	// ConfigMap to use to populate the volume.
	ConfigMap *KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemConfigMap `json:"configMap,omitempty" yaml:"configMap,omitempty" mapstructure:"configMap,omitempty"`

	// CSIVolumeSource object to use to populate the volume.
	Csi *KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemCsi `json:"csi,omitempty" yaml:"csi,omitempty" mapstructure:"csi,omitempty"`

	// EmptyDir to use to populate the volume.
	EmptyDir *KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemEmptyDir `json:"emptyDir,omitempty" yaml:"emptyDir,omitempty" mapstructure:"emptyDir,omitempty"`

	// Name to use for the volume. Required.
	Name *string `json:"name,omitempty" yaml:"name,omitempty" mapstructure:"name,omitempty"`

	// PersistentVolumeClaim object to use to populate the volume.
	PersistentVolumeClaim *KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemPersistentVolumeClaim `json:"persistentVolumeClaim,omitempty" yaml:"persistentVolumeClaim,omitempty" mapstructure:"persistentVolumeClaim,omitempty"`

	// Secret to use populate the volume.
	Secret *KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemSecret `json:"secret,omitempty" yaml:"secret,omitempty" mapstructure:"secret,omitempty"`
}

// ConfigMap to use to populate the volume.
type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemConfigMap struct {
	// DefaultMode corresponds to the JSON schema field "defaultMode".
	DefaultMode *int32 `json:"defaultMode,omitempty" yaml:"defaultMode,omitempty" mapstructure:"defaultMode,omitempty"`

	// Items corresponds to the JSON schema field "items".
	Items []KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemConfigMapItemsElem `json:"items,omitempty" yaml:"items,omitempty" mapstructure:"items,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemConfigMapItemsElem struct {
	// Key corresponds to the JSON schema field "key".
	Key *string `json:"key,omitempty" yaml:"key,omitempty" mapstructure:"key,omitempty"`
...
// CSIVolumeSource object to use to populate the volume.
type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemCsi struct {
	...
	NodePublishSecretRef *KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemCsiNodePublishSecretRef `json:"nodePublishSecretRef,omitempty" yaml:"nodePublishSecretRef,omitempty" mapstructure:"nodePublishSecretRef,omitempty"`

	// ReadOnly corresponds to the JSON schema field "readOnly".
	ReadOnly *bool `json:"readOnly,omitempty" yaml:"readOnly,omitempty" mapstructure:"readOnly,omitempty"`

	// VolumeAttributes corresponds to the JSON schema field "volumeAttributes".
	VolumeAttributes KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemCsiVolumeAttributes `json:"volumeAttributes,omitempty" yaml:"volumeAttributes,omitempty" mapstructure:"volumeAttributes,omitempty"`
}

type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemCsiNodePublishSecretRef struct {
	// Name corresponds to the JSON schema field "name".
	Name *string `json:"name,omitempty" yaml:"name,omitempty" mapstructure:"name,omitempty"`
}

type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemCsiVolumeAttributes map[string]string

// EmptyDir to use to populate the volume.
type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemEmptyDir struct {
	...
	SizeLimit *KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemEmptyDirSizeLimit `json:"sizeLimit,omitempty" yaml:"sizeLimit,omitempty" mapstructure:"sizeLimit,omitempty"`
}

type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemEmptyDirSizeLimit struct {
...
// PersistentVolumeClaim object to use to populate the volume.
type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemPersistentVolumeClaim struct {
...
// Secret to use populate the volume.
type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemSecret struct {
	// DefaultMode corresponds to the JSON schema field "defaultMode".
	DefaultMode *int32 `json:"defaultMode,omitempty" yaml:"defaultMode,omitempty" mapstructure:"defaultMode,omitempty"`

	// Items corresponds to the JSON schema field "items".
	Items []KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemSecretItemsElem `json:"items,omitempty" yaml:"items,omitempty" mapstructure:"items,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateBuildPodVolumesElemSecretItemsElem struct {
	// Key corresponds to the JSON schema field "key".
	Key *string `json:"key,omitempty" yaml:"key,omitempty" mapstructure:"key,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateConnectContainer struct {
	...
	// Additional volume mounts which should be applied to the container.
	VolumeMounts []KafkaMirrorMaker2SpecTemplateConnectContainerVolumeMountsElem `json:"volumeMounts,omitempty" yaml:"volumeMounts,omitempty" mapstructure:"volumeMounts,omitempty"`
}
...
type KafkaMirrorMaker2SpecTemplateConnectContainerEnvElem struct {
	...
	// Reference to the secret or config map property to which the environment
	// variable is set.
	ValueFrom *KafkaMirrorMaker2SpecTemplateConnectContainerEnvElemValueFrom `json:"valueFrom,omitempty" yaml:"valueFrom,omitempty" mapstructure:"valueFrom,omitempty"`
}

// Reference to the secret or config map property to which the environment variable
// is set.
type KafkaMirrorMaker2SpecTemplateConnectContainerEnvElemValueFrom struct {
	// Reference to a key in a config map.
	ConfigMapKeyRef *KafkaMirrorMaker2SpecTemplateConnectContainerEnvElemValueFromConfigMapKeyRef `json:"configMapKeyRef,omitempty" yaml:"configMapKeyRef,omitempty" mapstructure:"configMapKeyRef,omitempty"`

	// Reference to a key in a secret.
	SecretKeyRef *KafkaMirrorMaker2SpecTemplateConnectContainerEnvElemValueFromSecretKeyRef `json:"secretKeyRef,omitempty" yaml:"secretKeyRef,omitempty" mapstructure:"secretKeyRef,omitempty"`
}

// Reference to a key in a config map.
type KafkaMirrorMaker2SpecTemplateConnectContainerEnvElemValueFromConfigMapKeyRef struct {
	// Key corresponds to the JSON schema field "key".
	Key *string `json:"key,omitempty" yaml:"key,omitempty" mapstructure:"key,omitempty"`
...
// Reference to a key in a secret.
type KafkaMirrorMaker2SpecTemplateConnectContainerEnvElemValueFromSecretKeyRef struct {
	// Key corresponds to the JSON schema field "key".
	Key *string `json:"key,omitempty" yaml:"key,omitempty" mapstructure:"key,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateConnectContainerSecurityContext struct {
	...
	// AppArmorProfile corresponds to the JSON schema field "appArmorProfile".
	AppArmorProfile *KafkaMirrorMaker2SpecTemplateConnectContainerSecurityContextAppArmorProfile `json:"appArmorProfile,omitempty" yaml:"appArmorProfile,omitempty" mapstructure:"appArmorProfile,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateConnectContainerSecurityContextAppArmorProfile struct {
	// LocalhostProfile corresponds to the JSON schema field "localhostProfile".
	LocalhostProfile *string `json:"localhostProfile,omitempty" yaml:"localhostProfile,omitempty" mapstructure:"localhostProfile,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateConnectContainerVolumeMountsElem struct {
	// MountPath corresponds to the JSON schema field "mountPath".
	MountPath *string `json:"mountPath,omitempty" yaml:"mountPath,omitempty" mapstructure:"mountPath,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateInitContainer struct {
	...
	// Additional volume mounts which should be applied to the container.
	VolumeMounts []KafkaMirrorMaker2SpecTemplateInitContainerVolumeMountsElem `json:"volumeMounts,omitempty" yaml:"volumeMounts,omitempty" mapstructure:"volumeMounts,omitempty"`
}
...
type KafkaMirrorMaker2SpecTemplateInitContainerEnvElem struct {
	...
	// Reference to the secret or config map property to which the environment
	// variable is set.
	ValueFrom *KafkaMirrorMaker2SpecTemplateInitContainerEnvElemValueFrom `json:"valueFrom,omitempty" yaml:"valueFrom,omitempty" mapstructure:"valueFrom,omitempty"`
}

// Reference to the secret or config map property to which the environment variable
// is set.
type KafkaMirrorMaker2SpecTemplateInitContainerEnvElemValueFrom struct {
	// Reference to a key in a config map.
	ConfigMapKeyRef *KafkaMirrorMaker2SpecTemplateInitContainerEnvElemValueFromConfigMapKeyRef `json:"configMapKeyRef,omitempty" yaml:"configMapKeyRef,omitempty" mapstructure:"configMapKeyRef,omitempty"`

	// Reference to a key in a secret.
	SecretKeyRef *KafkaMirrorMaker2SpecTemplateInitContainerEnvElemValueFromSecretKeyRef `json:"secretKeyRef,omitempty" yaml:"secretKeyRef,omitempty" mapstructure:"secretKeyRef,omitempty"`
}

// Reference to a key in a config map.
type KafkaMirrorMaker2SpecTemplateInitContainerEnvElemValueFromConfigMapKeyRef struct {
	// Key corresponds to the JSON schema field "key".
	Key *string `json:"key,omitempty" yaml:"key,omitempty" mapstructure:"key,omitempty"`
...
// Reference to a key in a secret.
type KafkaMirrorMaker2SpecTemplateInitContainerEnvElemValueFromSecretKeyRef struct {
	// Key corresponds to the JSON schema field "key".
	Key *string `json:"key,omitempty" yaml:"key,omitempty" mapstructure:"key,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateInitContainerSecurityContext struct {
	...
	// AppArmorProfile corresponds to the JSON schema field "appArmorProfile".
	AppArmorProfile *KafkaMirrorMaker2SpecTemplateInitContainerSecurityContextAppArmorProfile `json:"appArmorProfile,omitempty" yaml:"appArmorProfile,omitempty" mapstructure:"appArmorProfile,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateInitContainerSecurityContextAppArmorProfile struct {
	// LocalhostProfile corresponds to the JSON schema field "localhostProfile".
	LocalhostProfile *string `json:"localhostProfile,omitempty" yaml:"localhostProfile,omitempty" mapstructure:"localhostProfile,omitempty"`
...
type KafkaMirrorMaker2SpecTemplateInitContainerVolumeMountsElem struct {
	// MountPath corresponds to the JSON schema field "mountPath".
	MountPath *string `json:"mountPath,omitempty" yaml:"mountPath,omitempty" mapstructure:"mountPath,omitempty"`
...
type KafkaMirrorMaker2SpecTemplatePod struct {
	...
	// Additional volumes that can be mounted to the pod.
	Volumes []KafkaMirrorMaker2SpecTemplatePodVolumesElem `json:"volumes,omitempty" yaml:"volumes,omitempty" mapstructure:"volumes,omitempty"`
}
...
type KafkaMirrorMaker2SpecTemplatePodSecurityContext struct {
	// AppArmorProfile corresponds to the JSON schema field "appArmorProfile".
	AppArmorProfile *KafkaMirrorMaker2SpecTemplatePodSecurityContextAppArmorProfile `json:"appArmorProfile,omitempty" yaml:"appArmorProfile,omitempty" mapstructure:"appArmorProfile,omitempty"`
...
type KafkaMirrorMaker2SpecTemplatePodSecurityContextAppArmorProfile struct {
	// LocalhostProfile corresponds to the JSON schema field "localhostProfile".
	LocalhostProfile *string `json:"localhostProfile,omitempty" yaml:"localhostProfile,omitempty" mapstructure:"localhostProfile,omitempty"`
...
type KafkaMirrorMaker2SpecTemplatePodVolumesElem struct {
	// ConfigMap to use to populate the volume.
	ConfigMap *KafkaMirrorMaker2SpecTemplatePodVolumesElemConfigMap `json:"configMap,omitempty" yaml:"configMap,omitempty" mapstructure:"configMap,omitempty"`

	// CSIVolumeSource object to use to populate the volume.
	Csi *KafkaMirrorMaker2SpecTemplatePodVolumesElemCsi `json:"csi,omitempty" yaml:"csi,omitempty" mapstructure:"csi,omitempty"`

	// EmptyDir to use to populate the volume.
	EmptyDir *KafkaMirrorMaker2SpecTemplatePodVolumesElemEmptyDir `json:"emptyDir,omitempty" yaml:"emptyDir,omitempty" mapstructure:"emptyDir,omitempty"`

	// Name to use for the volume. Required.
	Name *string `json:"name,omitempty" yaml:"name,omitempty" mapstructure:"name,omitempty"`

	// PersistentVolumeClaim object to use to populate the volume.
	PersistentVolumeClaim *KafkaMirrorMaker2SpecTemplatePodVolumesElemPersistentVolumeClaim `json:"persistentVolumeClaim,omitempty" yaml:"persistentVolumeClaim,omitempty" mapstructure:"persistentVolumeClaim,omitempty"`

	// Secret to use populate the volume.
	Secret *KafkaMirrorMaker2SpecTemplatePodVolumesElemSecret `json:"secret,omitempty" yaml:"secret,omitempty" mapstructure:"secret,omitempty"`
}

// ConfigMap to use to populate the volume.
type KafkaMirrorMaker2SpecTemplatePodVolumesElemConfigMap struct {
	// DefaultMode corresponds to the JSON schema field "defaultMode".
	DefaultMode *int32 `json:"defaultMode,omitempty" yaml:"defaultMode,omitempty" mapstructure:"defaultMode,omitempty"`

	// Items corresponds to the JSON schema field "items".
	Items []KafkaMirrorMaker2SpecTemplatePodVolumesElemConfigMapItemsElem `json:"items,omitempty" yaml:"items,omitempty" mapstructure:"items,omitempty"`
...
type KafkaMirrorMaker2SpecTemplatePodVolumesElemConfigMapItemsElem struct {
	// Key corresponds to the JSON schema field "key".
	Key *string `json:"key,omitempty" yaml:"key,omitempty" mapstructure:"key,omitempty"`
...
// CSIVolumeSource object to use to populate the volume.
type KafkaMirrorMaker2SpecTemplatePodVolumesElemCsi struct {
	// Driver corresponds to the JSON schema field "driver".
	Driver *string `json:"driver,omitempty" yaml:"driver,omitempty" mapstructure:"driver,omitempty"`
	...
	// NodePublishSecretRef corresponds to the JSON schema field
	// "nodePublishSecretRef".
	NodePublishSecretRef *KafkaMirrorMaker2SpecTemplatePodVolumesElemCsiNodePublishSecretRef `json:"nodePublishSecretRef,omitempty" yaml:"nodePublishSecretRef,omitempty" mapstructure:"nodePublishSecretRef,omitempty"`

	// ReadOnly corresponds to the JSON schema field "readOnly".
	ReadOnly *bool `json:"readOnly,omitempty" yaml:"readOnly,omitempty" mapstructure:"readOnly,omitempty"`

	// VolumeAttributes corresponds to the JSON schema field "volumeAttributes".
	VolumeAttributes KafkaMirrorMaker2SpecTemplatePodVolumesElemCsiVolumeAttributes `json:"volumeAttributes,omitempty" yaml:"volumeAttributes,omitempty" mapstructure:"volumeAttributes,omitempty"`
}

type KafkaMirrorMaker2SpecTemplatePodVolumesElemCsiNodePublishSecretRef struct {
	// Name corresponds to the JSON schema field "name".
	Name *string `json:"name,omitempty" yaml:"name,omitempty" mapstructure:"name,omitempty"`
}
...
type KafkaMirrorMaker2SpecTemplatePodVolumesElemCsiVolumeAttributes map[string]string
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMaker2SpecMirrorsElemSourceConnectorListOffsets) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["toConfigMap"]; !ok || v == nil {
		return fmt.Errorf("field toConfigMap in KafkaMirrorMaker2SpecMirrorsElemSourceConnectorListOffsets: required")
	}
	type Plain KafkaMirrorMaker2SpecMirrorsElemSourceConnectorListOffsets
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = KafkaMirrorMaker2SpecMirrorsElemSourceConnectorListOffsets(plain)
	return nil
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMaker2SpecMirrorsElemSourceConnectorAlterOffsets) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["fromConfigMap"]; !ok || v == nil {
		return fmt.Errorf("field fromConfigMap in KafkaMirrorMaker2SpecMirrorsElemSourceConnectorAlterOffsets: required")
	}
	type Plain KafkaMirrorMaker2SpecMirrorsElemSourceConnectorAlterOffsets
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = KafkaMirrorMaker2SpecMirrorsElemSourceConnectorAlterOffsets(plain)
	return nil
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorListOffsets) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["toConfigMap"]; !ok || v == nil {
		return fmt.Errorf("field toConfigMap in KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorListOffsets: required")
	}
	type Plain KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorListOffsets
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorListOffsets(plain)
	return nil
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorAlterOffsets) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["fromConfigMap"]; !ok || v == nil {
		return fmt.Errorf("field fromConfigMap in KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorAlterOffsets: required")
	}
	type Plain KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorAlterOffsets
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = KafkaMirrorMaker2SpecMirrorsElemHeartbeatConnectorAlterOffsets(plain)
	return nil
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorListOffsets) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["toConfigMap"]; !ok || v == nil {
		return fmt.Errorf("field toConfigMap in KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorListOffsets: required")
	}
	type Plain KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorListOffsets
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorListOffsets(plain)
	return nil
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorAlterOffsets) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["fromConfigMap"]; !ok || v == nil {
		return fmt.Errorf("field fromConfigMap in KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorAlterOffsets: required")
	}
	type Plain KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorAlterOffsets
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = KafkaMirrorMaker2SpecMirrorsElemCheckpointConnectorAlterOffsets(plain)
	return nil
}
...
type KafkaMirrorMaker2SpecTemplatePodVolumesElemEmptyDirSizeLimit struct {
	// Amount corresponds to the JSON schema field "amount".
	Amount *string `json:"amount,omitempty" yaml:"amount,omitempty" mapstructure:"amount,omitempty"`
...
// EmptyDir to use to populate the volume.
type KafkaMirrorMaker2SpecTemplatePodVolumesElemEmptyDir struct {
	// Medium corresponds to the JSON schema field "medium".
	Medium *string `json:"medium,omitempty" yaml:"medium,omitempty" mapstructure:"medium,omitempty"`

	// SizeLimit corresponds to the JSON schema field "sizeLimit".
	SizeLimit *KafkaMirrorMaker2SpecTemplatePodVolumesElemEmptyDirSizeLimit `json:"sizeLimit,omitempty" yaml:"sizeLimit,omitempty" mapstructure:"sizeLimit,omitempty"`
}

// PersistentVolumeClaim object to use to populate the volume.
type KafkaMirrorMaker2SpecTemplatePodVolumesElemPersistentVolumeClaim struct {
	// ClaimName corresponds to the JSON schema field "claimName".
	ClaimName *string `json:"claimName,omitempty" yaml:"claimName,omitempty" mapstructure:"claimName,omitempty"`
...
type KafkaMirrorMaker2SpecTemplatePodVolumesElemSecretItemsElem struct {
	// Key corresponds to the JSON schema field "key".
	Key *string `json:"key,omitempty" yaml:"key,omitempty" mapstructure:"key,omitempty"`
...
// Secret to use populate the volume.
type KafkaMirrorMaker2SpecTemplatePodVolumesElemSecret struct {
	// DefaultMode corresponds to the JSON schema field "defaultMode".
	DefaultMode *int32 `json:"defaultMode,omitempty" yaml:"defaultMode,omitempty" mapstructure:"defaultMode,omitempty"`

	// Items corresponds to the JSON schema field "items".
	Items []KafkaMirrorMaker2SpecTemplatePodVolumesElemSecretItemsElem `json:"items,omitempty" yaml:"items,omitempty" mapstructure:"items,omitempty"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaMirrorMaker2SpecClustersElemAuthenticationClientAssertion) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["key"]; !ok || v == nil {
		return fmt.Errorf("field key in KafkaMirrorMaker2SpecClustersElemAuthenticationClientAssertion: required")
	}
	if v, ok := raw["secretName"]; !ok || v == nil {
		return fmt.Errorf("field secretName in KafkaMirrorMaker2SpecClustersElemAuthenticationClientAssertion: required")
	}
	type Plain KafkaMirrorMaker2SpecClustersElemAuthenticationClientAssertion
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = KafkaMirrorMaker2SpecClustersElemAuthenticationClientAssertion(plain)
	return nil
}
