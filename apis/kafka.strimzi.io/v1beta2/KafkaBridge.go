...
type KafkaBridgeSpecAuthentication struct {
	...
	SaslExtensions KafkaBridgeSpecAuthenticationSaslExtensions `json:"saslExtensions,omitempty" yaml:"saslExtensions,omitempty" mapstructure:"saslExtensions,omitempty"`
...
// SASL extensions parameters.
type KafkaBridgeSpecAuthenticationSaslExtensions map[string]string
...
type KafkaBridgeSpecTemplatePodVolumesElemCsi struct {
	...
	VolumeAttributes KafkaBridgeSpecTemplatePodVolumesElemCsiVolumeAttributes `json:"volumeAttributes,omitempty" yaml:"volumeAttributes,omitempty" mapstructure:"volumeAttributes,omitempty"`
}
...
type KafkaBridgeSpecTemplatePodVolumesElemCsiVolumeAttributes map[string]string
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaBridgeSpecAuthenticationClientAssertion) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
