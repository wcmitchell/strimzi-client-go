...
type KafkaConnectSpecAuthentication struct {
	...
	SaslExtensions KafkaConnectSpecAuthenticationSaslExtensions `json:"saslExtensions,omitempty" yaml:"saslExtensions,omitempty" mapstructure:"saslExtensions,omitempty"`
...
// SASL extensions parameters.
type KafkaConnectSpecAuthenticationSaslExtensions map[string]string
...
type KafkaConnectSpecBuildOutput struct {
	...
	// --registry-certificate, --registry-client-cert. These options will be used only
	// on Kubernetes where the Kaniko executor is used. They will be ignored on
...
type KafkaConnectSpecTemplateBuildPodVolumesElemCsi struct {
	...
	VolumeAttributes KafkaConnectSpecTemplateBuildPodVolumesElemCsiVolumeAttributes `json:"volumeAttributes,omitempty" yaml:"volumeAttributes,omitempty" mapstructure:"volumeAttributes,omitempty"`
}
...
type KafkaConnectSpecTemplateBuildPodVolumesElemCsiVolumeAttributes map[string]string
...
type KafkaConnectSpecTemplatePodVolumesElemCsi struct {
	...
	// VolumeAttributes corresponds to the JSON schema field "volumeAttributes".
	VolumeAttributes KafkaConnectSpecTemplatePodVolumesElemCsiVolumeAttributes `json:"volumeAttributes,omitempty" yaml:"volumeAttributes,omitempty" mapstructure:"volumeAttributes,omitempty"`
}
...
type KafkaConnectSpecTemplatePodVolumesElemCsiVolumeAttributes map[string]string
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *KafkaConnectSpecAuthenticationClientAssertion) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
