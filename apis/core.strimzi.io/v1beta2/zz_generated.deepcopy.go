...
func (in *StrimziPodSet) DeepCopyInto(out *StrimziPodSet) {
	*out = *in
	...
	if in.Metadata != nil {
		...
		*out = make(StrimziPodSetMetadata, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in StrimziPodSetMetadata) DeepCopyInto(out *StrimziPodSetMetadata) {
	{
		in := &in
		*out = make(StrimziPodSetMetadata, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StrimziPodSetMetadata.
func (in StrimziPodSetMetadata) DeepCopy() StrimziPodSetMetadata {
	if in == nil {
		return nil
	}
	out := new(StrimziPodSetMetadata)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *StrimziPodSetSpec) DeepCopyInto(out *StrimziPodSetSpec) {
	*out = *in
	if in.Pods != nil {
		...
		*out = make([]StrimziPodSetSpecPodsElem, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = make(StrimziPodSetSpecPodsElem, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in StrimziPodSetSpecPodsElem) DeepCopyInto(out *StrimziPodSetSpecPodsElem) {
	{
		in := &in
		*out = make(StrimziPodSetSpecPodsElem, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StrimziPodSetSpecPodsElem.
func (in StrimziPodSetSpecPodsElem) DeepCopy() StrimziPodSetSpecPodsElem {
	if in == nil {
		return nil
	}
	out := new(StrimziPodSetSpecPodsElem)
	in.DeepCopyInto(out)
	return *out
}
